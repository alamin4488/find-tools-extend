...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@bubt-project.qa0n2s6.mongodb.net/?retryWrites=true&w=majority`;
// const uri = `mongodb+srv://${env.process.DB_USER}:${env.process.DB_PASS}@bubt-project.qa0n2s6.mongodb.net/?retryWrites=true&w=majority`;
